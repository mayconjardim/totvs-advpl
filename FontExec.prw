...
oDlg1      := MSDialog():New( 092,232,592,927,"FontExec - Executando Programas ADVPL",,,.F.,,,,,,.T.,,,.T. )
...
oSay5      := TSay():New( 167,011,{||'fNome("Teste")'},oDlg1,,oFont2,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,073,008)
oSay6      := TSay():New( 001,081,{||"Bem vindo ao Font EXEC"},oDlg1,,oFont1,.F.,.F.,.F.,.T.,CLR_BLUE,CLR_WHITE,187,016)
oSay7      := TSay():New( 014,086,{||'""'},oDlg1,,oFont3,.F.,.F.,.F.,.T.,CLR_BLUE,CLR_WHITE,162,016)
oSay8      := TSay():New( 127,011,{||""},oDlg1,,oFont2,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,047,008)
oSay9      := TSay():New( 140,012,{||""},oDlg1,,oFont2,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,047,008)
oSay10     := TSay():New( 180,012,{||""},oDlg1,,oFont2,.F.,.F.,.F.,.T.,CLR_BLACK,CLR_WHITE,047,008)
